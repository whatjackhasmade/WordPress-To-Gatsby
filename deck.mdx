...
<Notes>
Installing Beta 4.0 introduces breaking changes to how repeater fields are output in my process.
...
<Notes>
	With this code, we are essentially saying to Gutenberg, only display the
	blocks with these names.
</Notes>
...
<CodeSurfer theme={shadesOfPurple} code={HeroTwig} lang="twig" />
...
<CodeSurfer
	...
	steps={[
		...
		},
		{
			range: [14, 16],
			notes:
				"Finally I am using a new functoin parse_blocks to process the block string and returning it as an array of objects"
		}
	]}
/>
